...
{
    ItemManager.getReward(id,num, message);
}

function getMinigamePersistentReward(id,num, message)
{
    ItemManager.getPersistentReward(id,num, message);
}
function getMinigameMultiplayerReward(id,num, message)
{
    ItemManager.getMultiplayerReward(id,num, message);
}
