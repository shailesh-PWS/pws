var DialogManager = new function(){
    ...
    this.StopDialog=function(callback){
        DialogManager.cb = callback;
        UniwebviewManager.StopDialog("DialogManager.callback");
    }
    this.PlayDialog=function(audio,callback){
        DialogManager.cb = callback;
        UniwebviewManager.PlayDialog(audio,"DialogManager.callback");
    }
