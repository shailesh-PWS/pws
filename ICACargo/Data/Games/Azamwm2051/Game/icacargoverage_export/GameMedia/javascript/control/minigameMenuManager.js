...
var minigameMenuManager = new function(){
    this.populate = function(){
       ...
       // minigameControl.Array.push(minigameControl.MenuObject);
        if(!backToMenuBool)
        Log.addAction("menuMiniGame",minigameControl.MenuObject,"minigameMenuManager.menuPopulate");
        else minigameMenuManager.menuPopulate();
    };
    this.menuPopulate = function(){
    ...
    this.setupListener=function(){
        $("#closeMenuBtnImg").unbind().click(function(){
            minigameControl.MenuObject.status = "Ended";
            minigameControl.Array=[];
            Log.addAction("menuMiniGame",minigameControl.MenuObject,"minigameMenuManager.callClose");
           
        });
    };
    this.callClose = function(){
